...
namespace ExpertTest
{
    ...
    partial void InsertPropertyWeight(PropertyWeight instance);
    partial void UpdatePropertyWeight(PropertyWeight instance);
    partial void DeletePropertyWeight(PropertyWeight instance);
    ...
    partial void DeleteProperty(Property instance);
		...
		public ExpDataContext() : 
				base(global::ExpertTest.Properties.Settings.Default.ExpSysConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<PropertyWeight> PropertyWeights
		{
			get
			{
				return this.GetTable<PropertyWeight>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PropertyWeight")]
	public partial class PropertyWeight : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	public partial class UserBook : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _PropetyID;
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnPropetyIDChanging(System.Nullable<int> value);
    partial void OnPropetyIDChanged();
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PropetyID", DbType="Int")]
		public System.Nullable<int> PropetyID
		{
			get
			{
				return this._PropetyID;
			}
			set
			{
				if ((this._PropetyID != value))
				{
					this.OnPropetyIDChanging(value);
					this.SendPropertyChanging();
					this._PropetyID = value;
					this.SendPropertyChanged("PropetyID");
					this.OnPropetyIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserBook", Storage="_User", ThisKey="UserId", OtherKey="Id", IsForeignKey=true, DeleteRule="SET DEFAULT")]
		public User User
		{
			get
			{
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserProperty", Storage="_User", ThisKey="UserId", OtherKey="Id", IsForeignKey=true, DeleteRule="SET NULL")]
		public User User
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.UserQuestion")]
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserQuestion", Storage="_User", ThisKey="UserId", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnBanChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserQuestion", Storage="_UserQuestions", ThisKey="Id", OtherKey="UserId")]
    ...
    partial void OnPropertyValueChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PropertyValue", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
